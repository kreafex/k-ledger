...
import { 
  ...
  ChevronDown, ChevronRight, Save, Download, Menu, Calendar 
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-brand-light overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="md:hidden bg-white shadow-sm h-16 flex items-center justify-between px-4"><span className="text-xl font-bold text-brand-navy">K-Ledger</span><Menu className="text-brand-navy" /></div>
